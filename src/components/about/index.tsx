...
export default function About(){
    return(
        ...
        <div className="min-h-screen bg-gradient-to-r from-indigo-100 to-indigo-50 items-center justify-center 
            ...
            <h1 className="text-4xl sm:text-4xl md:text-6xl  font-semibold text-center bg-white text-blue-500 drop-shadow-sm px-2 py-10 ">Driven by innovation</h1>
                <p className="font-semibold text-black text-center text-4xl py-0 mt-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 text-center  gap-4 p-6">
                <div className="bg-blue-200 flex flex-col items-center text-center h-fit p-4">
                    <h1 className="text-3xl text-center text-gray-600 py-4">Our Vision</h1>
                    <p className="text-gray-950 px-12 py-6 relative">
