...
export default function SideBar(){
    return(
        ...
        <aside className="w-64 bg-white shadow-md hidden z-20 md:block">
          <div className=""><Hamburger/></div>
                ...
                <nav className="p-4">
                  <ul className="text-center justify-center">
                    ...
                    <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-500">Active Loans</a></li>
                    <li className="mb-2"><a href="#" className="text-gray-700 hover:text-blue-500">Closed Loans</a></li>
